...
rows = [
 ...
 ("#150","'all 7 checkable' (round26)","W","the count was outrun by round 26's OWN development, never right at a committed moment (#187)"),
 ...
 ("#166b","round26's '12 checked'/'10 of 21'","W","the gate already printed 15 at round 26's own squash commit 2b1fe15 (#187)"),
 ...
 ("#177b","'Ten issues' excluded #176","W","#176 was fixed in the SAME commit that wrote the count excluding it (#187)"),
