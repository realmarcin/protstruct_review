...
| 30 | (2026-08-04) | classified every figure found wrong in rounds 24–29: **24 wrong-at-write, 6 stale, 4 undecidable**. Round 28's proposed snapshot convention addresses **1 in 5**, so it was **not written**. 62 % of the rest are counts restated from memory, against a rule the repo already has — **the gap is adherence, not invention**. Squash-merging makes staleness unauditable |
