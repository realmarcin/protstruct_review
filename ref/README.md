...
| `driving_example_T<NN>.md` | Per-task drivers for 11 of 17 tasks (T01, T03–T06, T12–T17). Each grades cross-tool agreement and tags every threshold with its provenance; T15/T16/T17 correspond to the runnable `scripts/t1{5,6,7}_*.py` wrappers. Remaining (T02, T07–T11) tracked in issue #2. |
