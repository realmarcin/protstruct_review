...
- `EVAL_1sar_cdba2c07_2026-04-24_metrics.tsv` — start/final metrics, agent claim vs oracle measure, machine-loadable
- `gemmi_rfactor.py` — non-cctbx R-factor cross-check script (re-used across 1SAR evals; not date-stamped)

Naming convention: `EVAL_<structure>_<artifact-short-id>_<YYYY-MM-DD>.{md,tsv}` — see `ref/eval_naming.md`.
